// An example of a simple application on Genesis, which contains all the components necessary for existence and also
// one custom IGameLoopObject, which outputs an inscription to the SDL console every frame
...
class Example : public genesis::IGameLoopObject
{
public:
    virtual void Update(float delta) override
    {
        SDL_Log("Hello from Example game loop object!");
    }
};
...
int main(int argc, char **argv)
{
    ...
    // Adding custom game loop object to loop
// =====================================================================================================================
    auto example = genesis::SharedPointer(new Example());
